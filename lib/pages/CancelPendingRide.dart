...
class CancelPendingRide extends StatelessWidget {
  CancelPendingRide({this.rideid,this.numspot,this.reqid});
  int numspot;
  String rideid;
  String reqid;
 ...
 child: Container(
          child:StreamBuilder(
              ...
              builder: (_, snapshot) {
                ...
                {
                    return Center(child:Text("Request Cancelled Successfully",style:TextStyle(fontSize: 20,color: Colors.green,fontWeight: FontWeight.bold),));
                } 
                else {
